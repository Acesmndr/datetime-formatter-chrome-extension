# Datetime Formatter Chrome Extension

The [extension](https://developer.chrome.com/extensions) formats all the date and time in current page to specified format. This is specifically targetted for users/developers who need to deal with large number of logs and the date and time are in various formats.
...
A [changelog](https://github.com/Acesmndr/datetime-formatter-chrome-extension/blob/master/changelog.md) has been maintained to keep track of all the changes made in the extension along with semantic versioning

### Versioning

We use [SemVer](http://semver.org/) for versioning. For the versions available, see the [tags on this repository](https://github.com/Acesmndr/datetime-formatter-chrome-extension/tags).
